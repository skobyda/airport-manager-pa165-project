...
class AirportDaoImplTest {
    ...
    private Airport LincolnAirport;
    ...
    void setUp() {
        ...
        LincolnAirport.setCountry("AU");
        LincolnAirport.setName("LincolnAirport");
        LincolnAirport.setCity("Vienna");

        airportDao.create(KennedyAirport);
        airportDao.create(WashingtonAirport);
        airportDao.create(LincolnAirport);
    ...
    void findByName() {
        /*
        List<Airport> airportByName=airportDao.findByName("Kennedy airport");
        Assertions.assertEquals(1,airportByName.size());
        Assertions.assertEquals("Kennedy airport",airportByName.get(1).getName());
        */
    }
    ...
    void findByCity() {
        /*
        List<Airport> airportByCity=airportDao.findByName("Los Angeles");
        Assertions.assertEquals(1,airportByCity.size());
        Assertions.assertEquals("Los Angeles",airportByCity.get(1).getName());
    ...
    @Test
    void delete() {
        airportDao.delete(LincolnAirport);
        Assertions.assertEquals(2,airportDao.findAll().size());
    }
